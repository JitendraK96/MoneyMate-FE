  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative border text-[var(--content-textprimary)] border-[var(--content-textplaceholder)] shadow-xs rounded-md",
